...
HADOOP_YARN_RESOURCEMANAGER_FILE_PATH=$JAR_PREFIX/yarn/hadoop-yarn-server-resourcemanager-2.6.0.jar
HADOOP_YARN_CLIENT_FILE_PATH=$JAR_PREFIX/yarn/hadoop-yarn-client-2.6.0.jar
